...
var btnDecrease = document.querySelector('#decrease'); // 액션의 이름을 정의한다. 액션 이름은 문자열 형태로, 주로 대문자로 작성하며 액션 이름은 고유해야 한다.

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 위에서 만든 액션 이름을 사용하여 액션 객체를 만드는 액션 생성 함수를 작성한다. 반드시 type 값을 갖고 있어야 한다.
...
var store = (0, _redux.createStore)(reducer); // 파라미터에 reducer 함수를 넣어준다.
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4692" + '/');
